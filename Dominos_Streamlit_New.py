...
def load_lstm_model():
    ...
    loaded_model = load_model(r'C:\Users\VRISHALI\lstm_pizza_model.keras')
    return loaded_model
...
if st.button('Predict 🚀'):
    ...
    if days_to_forecast <= 0:
        ...
        Ingredients_df = pd.read_csv(r'D:\Dominos\Pizza_ingredients_cleaned.csv')
        ...
        df_merged = pd.merge(df_forecast_long, Ingredients_df, on='pizza_name_id')
        ...
        for day, quantities in enumerate(rounded_predictions):
            ...
            for i, quantity in enumerate(quantities):
                if quantity > 0:
                    ...
                    pizza_info = Ingredients_df[Ingredients_df['pizza_name_id'] == pizza_code]
            ...
            for day, quantities in enumerate(rounded_predictions):
                ...
                for i, quantity in enumerate(quantities):
                    if quantity > 0:
                        ...
                        # Get pizza name and size from Ingredients_df
                        pizza_info = Ingredients_df[Ingredients_df['pizza_name_id'] == pizza_code]
