...
def load_data():
    ...
    dfs = pd.read_csv('D:\Dominos\Pizza_Sale_Cleaned.csv')
...
def load_lstm_model():
    ...
    loaded_model = load_model("D:\Dominos\lstm_pizza_model.keras")
    return loaded_model
...
if st.button('Predict 🚀'):
    ...
    if days_to_forecast <= 0:
        ...
        Ingredients_df = pd.read_csv('D:\Dominos\Pizza_Ingredients_cleaned.csv')
