...
def load_data():
    ...
    dfs = pd.read_csv('data/Pizza_Sale_Cleaned.csv')
...
if st.button('Predict 🚀'):
    ...
    if days_to_forecast <= 0:
        ...
        Ingredients_df = pd.read_csv('data/Pizza_ingredients_cleaned.csv')
            ...
            for day, quantities in enumerate(rounded_predictions):
                ...
                for i, quantity in enumerate(quantities):
                    if quantity > 0:
                        ...
                        pizza_info = Ingredients_df[df_ing['pizza_name_id'] == pizza_code]
